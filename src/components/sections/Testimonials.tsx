...
const testimonials = [
  { name: "سارة الخطيب", text: "الدروس كانت ممتعة وسهلة الفهم، والمدرب كان دائمًا متعاونًا ويجيب على جميع أسئلتي. أشعر أنني تقدمت كثيرًا في وقت قصير!" },
  { name: "أحمد العمري", text: "المنصة منظمة بشكل رائع، وكل شيء واضح من البداية. أحببت أسلوب الشرح العملي الذي ساعدني على التطبيق فورًا." },
